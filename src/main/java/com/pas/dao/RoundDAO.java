...
public class RoundDAO implements Serializable
{
	...
	public void readAllRoundsFromDB()
    {
		...
		while (results.hasNext()) 
        {
			...
			{
				round = Utils.setDisplayScore(1, round.getHole1Score(), game.getCourse(), round);
			}
			
			if (round.getHole2Score() != null)
			{
				round = Utils.setDisplayScore(2, round.getHole2Score(), game.getCourse(), round);
			}
			
			if (round.getHole3Score() != null)
			{
				round = Utils.setDisplayScore(3, round.getHole3Score(), game.getCourse(), round);
			}
			
			if (round.getHole4Score() != null)
			{
				round = Utils.setDisplayScore(4, round.getHole4Score(), game.getCourse(), round);
			}
			
			if (round.getHole5Score() != null)
			{
				round = Utils.setDisplayScore(5, round.getHole5Score(), game.getCourse(), round);
			}
			
			if (round.getHole6Score() != null)
			{
				round = Utils.setDisplayScore(6, round.getHole6Score(), game.getCourse(), round);
			}
			
			if (round.getHole7Score() != null)
			{
				round = Utils.setDisplayScore(7, round.getHole7Score(), game.getCourse(), round);
			}
			
			if (round.getHole8Score() != null)
			{
				round = Utils.setDisplayScore(8, round.getHole8Score(), game.getCourse(), round);
			}
			
			if (round.getHole9Score() != null)
			{
				round = Utils.setDisplayScore(9, round.getHole9Score(), game.getCourse(), round);
			}
			
			if (round.getHole10Score() != null)
			{
				round = Utils.setDisplayScore(10, round.getHole10Score(), game.getCourse(), round);
			}
			
			if (round.getHole11Score() != null)
			{
				round = Utils.setDisplayScore(11, round.getHole11Score(), game.getCourse(), round);
			}
			
			if (round.getHole12Score() != null)
			{
				round = Utils.setDisplayScore(12, round.getHole12Score(), game.getCourse(), round);
			}
			
			if (round.getHole13Score() != null)
			{
				round = Utils.setDisplayScore(13, round.getHole13Score(), game.getCourse(), round);
			}
			
			if (round.getHole14Score() != null)
			{
				round = Utils.setDisplayScore(14, round.getHole14Score(), game.getCourse(), round);
			}
			
			if (round.getHole15Score() != null)
			{
				round = Utils.setDisplayScore(15, round.getHole15Score(), game.getCourse(), round);
			}
			
			if (round.getHole16Score() != null)
			{
				round = Utils.setDisplayScore(16, round.getHole16Score(), game.getCourse(), round);
			}
			
			if (round.getHole17Score() != null)
			{
				round = Utils.setDisplayScore(17, round.getHole17Score(), game.getCourse(), round);
			}
			
			if (round.getHole18Score() != null)
			{
				round = Utils.setDisplayScore(18, round.getHole18Score(), game.getCourse(), round);
			}
