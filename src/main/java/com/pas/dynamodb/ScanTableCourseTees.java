...
public class ScanTableCourseTees
{	 
	...
	private static void scan(DynamoDbTable<DynamoCourseTee> table) 
    {
        ...
        try 
        {
            ...
            while (results.hasNext()) 
            {
                ...
                System.out.println("courseTeeID = " + rec.getCourseTeeID()
                        + "  oldcourseteeID = " + rec.getOldCourseTeeID()
                		+ "  courseID = " + rec.getCourseID()
                		+ "  teeColor = " + rec.getTeeColor()
                		+ "  coursePar = " + rec.getCoursePar()
                		+ "  courseRating = " + rec.getCourseRating()
                		+ "  slopeRating = " + rec.getSlopeRating()
                		+ "  totalYardage = " + rec.getTotalYardage());
            }
        } 
